...
___  ____/________  /___  __ \_ |  / /___  ____  /__________  __
__  __/  _  ___/_  __ \  / / /_ | / /_  / / /_  /__  __ \_  |/_/
_  /___  / /__ _  / / / /_/ /__ |/ / / /_/ /_  / _  / / /_>  <  
/_____/  \___/ /_/ /_/\____/ _____/  \__,_/ /_/  /_/ /_//_/|_|  
                                                                

{Fore.GREEN}V 1.2
{Fore.GREEN}By whoamikiddie
{Fore.RESET}
"""
...
async def update_script():
    try:
        ...
        try:
            ...
            if current == remote:
                print(f"{Fore.GREEN}Ech0Vulnx is already up to date!{Style.RESET_ALL}")
                return True
        ...
        try:
            ...
            if "Already up to date" in result.stdout:
                ...
                print(f"\n{Fore.GREEN}Ech0Vulnx has been updated successfully!{Style.RESET_ALL}")
                print(f"{Fore.YELLOW}Please restart Ech0Vulnx to apply the updates.{Style.RESET_ALL}")
